...
public final class TrChatServerEvents {
    ...
    public void onServerStarted(ServerStartedEvent event) {
        ...
        TrChatMod.LOGGER.info("{} started with {} channels (NeoForge 21.1.233+, Redis-only transport)",
    ...
    /** 与 Bukkit 上游一致：Options.Disabled-Worlds 中的世界禁用 TrChat 接管 */
    private boolean isDisabledWorld(ServerPlayer player) {
